...
const Card = ({ image, text, color }: ICard) => {
  ...
  return (
    <div
      ...
      className={`grid gap-9 place-content-center py-7 rounded-xl lg:py-0 lg:gap-0 lg:h-full text-dark dark:text-lite lg:flex-1 cursor-pointer hover:text-white ${color}`}
    >

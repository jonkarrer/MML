...
const Premium: FC = () => {
  return (
    <article className="plan py-10 border-t-8 dark:border-1 dark:border-121212 dark:border-t-8 border-collapse border-t-BFE5FF dark:border-t-6BC3FF md:relative">

...
const Start: FC = () => (
  <section className="bg-F6F8FE dark:bg-dark_grad">
    <article className="wrapper grid place-items-center gap-7 dark:bg-000-80 bg-white shadow-action rounded-base py-8 md:gap-8 lg:flex lg:justify-between lg:px-20 lg:h-52">

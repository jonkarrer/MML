...
const wrapper =
  "grid grid-flow-col place-content-start items-center gap-3 opacity-80 hover:opacity-100";
const text = "text-14 font-medium text-3D5368 dark:text-white";
...
export const Triangle = () => (
  ...
  >
    <path
      d="M5.22917 0.932708C5.62912 0.448766 6.37088 0.448765 6.77083 0.932707L11.5753 6.74613C12.1142 7.3982 11.6504 8.38318 10.8045 8.38318H1.19554C0.349615 8.38318 -0.114176 7.3982 0.424717 6.74613L5.22917 0.932708Z"
      className="fill-current text-white dark:text-121212"
    />
  </svg>
);

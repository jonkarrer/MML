...
const wrapper =
  "grid grid-flow-col place-content-start items-center gap-3 text-3D5368 opacity-80 hover:opacity-100";
const text = "text-14 font-medium";
...
export const Triangle = () => (
  ...
  >
    <path
      ...
      className="fill-current text-white dark:bg-121212"
    />
  </svg>
);
